...
import vn.edu.fpt.swp391.g6.rimsapi.dto.request.menu.*;
...
public class AdminController {
    ...
    public InvoiceDetailResponse getInvoiceDetail(@PathVariable Long invoiceId) {
    ...
    public RevenueComparisonResponse compareRevenue(
        ...
        return revenueReportService.compareRevenue(startDate1, endDate1, startDate2, endDate2);
    }
    ...
    public List<ReservationPerformanceScoreResponse> getReservationPerformanceScore(
            @RequestParam LocalDate fromDate,
            @RequestParam LocalDate toDate) {
        return reservationPerformanceScoreService.getReservationPerformanceScore(fromDate, toDate);
    }
    ...
    public ResponseEntity<DishResponse> createDish(@RequestBody @Valid CreateDishRequest createDishRequest) {
